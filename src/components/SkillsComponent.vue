<template>
    ...
    <div class="cards bg-gray-600 m-2 p-6 gap-2">
       ...
       <p class="text-white">Create digital product with unique idea</p> 
    </div>
    <div class="cards bg-gray-600 m-2 p-6 gap-2">
       <p class="text-green-500">Software Development</p>
       <p class="text-white">I Develop Application with coding super smooth.</p> 
    </div>
    <div class="cards bg-gray-600 m-2 p-6 gap-2">
